...
<head>
    ...
    <link rel="stylesheet" href="../../bootstrap-4.3.1/dist/css/skins/skin-blue.min.css">
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/words/delete?individualName=${individual.getLocalName()}"  data-toggle="modal"> <i class="fa fa-trash" style="font-size:23px;color:#ff0000"></i> </a>
                                </td>
                            </tr>
                            </#list>
                        </table>
