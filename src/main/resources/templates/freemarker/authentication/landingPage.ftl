...
<head>
    ...
    <title>Diccionario Dominicano</title>
    ...
    <link type="text/css" rel="stylesheet" href="../../bootstrap-4.3.1/style/cover.css" />
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    <header class="mb-auto">
        <div>
            <h3 class="float-md-start mb-0">Diccionario Dominicano</h3>
