...
<#--            Mientras resuelvo lo de separar usuario sin log de usuario normal comentare varias cosas-->
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class=""><a href="/dashboard/individuals">Administración de ontología</a></li>
...
<script>
    ...
    let totalInitialVote = ${initialVotesQuantity};
    let totalFinalVote = ${finalVotesQuantity};
    let totalAcceptedWords = ${acceptedWordsQuantity};
    ...
    new Chart(document.getElementById("pie-chart"), {
        ...
        type: 'pie',
        data: {
            labels: ["Total palabras en Votacion inicial", "Total palabras en votacion final", "Total palabras aceptadas"],
            datasets: [{
                label: "Cantidad",
                backgroundColor: ["#5ecd05", "#ba301c", "#004fa2"],
                data: [totalInitialVote, totalFinalVote, totalAcceptedWords]
            }]
        },
        options: {
            title: {
