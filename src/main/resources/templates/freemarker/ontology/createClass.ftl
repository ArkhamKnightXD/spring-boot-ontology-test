            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="post" action="/dashboard/class-create">
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="fatherClassName" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="name">Clase Hija</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="subClass" id="subClass" required>
                                </div>
                            </div>
                        </div>
